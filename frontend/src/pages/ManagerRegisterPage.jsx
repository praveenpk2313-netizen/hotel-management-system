  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await registerUser({
        ...
        role:         'manager', // Explicitly registering a manager account
      });

      navigate('/manager/login', { state: { message: 'Registration successful! Please log in.' } });
    } catch (err) {
        ...
        <div className="form-panel" style={{
          ...
          overflowY: 'auto'
           ...
           <div style={{
             ...
             ℹ️ Your email must be pre-approved by the Admin to receive Manager privileges.
           </div>
           ...
           <div style={{ marginTop: '1.5rem', fontSize: '0.85rem', color: '#111', fontWeight: '500', textAlign: 'center' }}>
             Already a manager? <Link to="/manager/login" style={{ color: '#111', textDecoration: 'underline', fontWeight: '700' }}>Sign In Now!</Link>
           </div>
