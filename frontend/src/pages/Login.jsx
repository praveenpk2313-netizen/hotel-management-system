    ...
    <div className="min-h-screen bg-white pt-32 lg:pt-40 pb-20 px-4 flex items-center justify-center">
      <div className="max-w-md w-full space-y-10 animate-fade-in">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            <div className="flex justify-between items-center">
               ...
               <Link to="/forgot-password" size={18} className="text-xs text-[#006ce4] font-bold hover:underline">Forgot your password?</Link>
            </div>
            <div className="relative">
               <input 
                ...
                required 
                className="w-full h-12 px-4 pr-10 bg-white border border-gray-300 rounded-lg text-gray-900 font-medium 
                           focus:border-[#006ce4] focus:ring-4 focus:ring-blue-50 transition-all outline-none"
               />
               <button 
                type="button" 
          ...
          <button 
            type="submit" 
            disabled={loading} 
            className="w-full h-12 bg-[#006ce4] text-white font-bold rounded-lg hover:bg-[#0052ad] transition-all flex items-center justify-center gap-2 active:scale-95 disabled:opacity-70 shadow-lg shadow-blue-500/10"
          >
            {loading ? <Loader2 size={20} className="animate-spin" /> : <Zap size={18} fill="currentColor" />}
            Sign In
          </button>
        </form>
        ...
        <p className="text-center text-gray-500 font-medium">
           Don't have an account? <Link to="/register" className="text-[#006ce4] font-black hover:underline">Create one</Link>
        </p>
