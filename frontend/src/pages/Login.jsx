...
import { AlertCircle, Eye, EyeOff, Github, Mail, Lock, ShieldCheck } from 'lucide-react';
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', margin: '2.5rem 0' }}>
             ...
             <span style={{ fontSize: '0.75rem', color: '#94a3b8', fontWeight: '700', textTransform: 'uppercase' }}>Or Sign In With</span>
             <div style={{ flex: 1, height: '1px', background: '#f1f5f9' }}></div>
          </div>
