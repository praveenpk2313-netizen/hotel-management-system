...
import { AlertCircle, Eye, EyeOff, Github, X } from 'lucide-react';
...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Navigate to intended destination with preserved state (crucial for booking intent)
      const from = location.state?.from;
      if (from) {
        // Exclude 'from' itself and 'message' to keep state clean, but keep bookingData
        const { from: _, message: __, ...preservedState } = location.state;
