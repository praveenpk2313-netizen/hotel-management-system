      ...
      if (event.data?.type === 'OAUTH_SUCCESS') {
        try {
          ...
          if (userData.role !== 'manager' && userData.role !== 'admin') {
            setError(`Access denied. Your account (${userData.email}) does not have Manager privileges.`);
            return;
          }
          login(userData);
        ...
        <div className="form-panel" style={{
          ...
          background: 'white'
           ...
           <div style={{ marginTop: '1.5rem', fontSize: '0.85rem', color: '#111', fontWeight: '500', textAlign: 'center' }}>
             New manager? <Link to="/manager/register" style={{ color: '#111', textDecoration: 'underline', fontWeight: '700' }}>Register Now!</Link>
           </div>
